...
public class TopicService implements Service {
    ...
    private Optional<String> get(Req req) {
        ...
        ConcurrentHashMap<String, ConcurrentLinkedQueue<String>> allSubscriptions = queues.get(id);
        ...
        if (queue == null) {
            optional = Optional.of(String.format("%s subscription for user %s is subscribed", subscriptionName, id));
        }
        if (message != null) {
